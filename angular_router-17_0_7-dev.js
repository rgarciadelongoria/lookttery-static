...
import { ɵisPromise, ɵRuntimeError, Injectable, EventEmitter, inject, ViewContainerRef, ChangeDetectorRef as ChangeDetectorRef2, EnvironmentInjector as EnvironmentInjector2, Directive, Input, Output, InjectionToken, reflectComponentType, Component, createEnvironmentInjector, ɵisNgModule, isStandalone, ɵisInjectable, runInInjectionContext, Compiler as Compiler2, NgModuleFactory, NgZone as NgZone2, afterNextRender, ɵConsole, ɵInitialRenderPendingTasks, ɵɵsanitizeUrlOrResourceUrl, booleanAttribute, Attribute, HostBinding, HostListener, Optional, ContentChildren, makeEnvironmentProviders, APP_BOOTSTRAP_LISTENER, ENVIRONMENT_INITIALIZER, Injector, ApplicationRef, InjectFlags, APP_INITIALIZER, SkipSelf, NgModule, Inject, Version } from "@angular/core";
...
var RouterOutlet = class _RouterOutlet {
   ...
   */
  get component() {
    if (!this.activated) throw new ɵRuntimeError(4012, (typeof ngDevMode === "undefined" || ngDevMode) && "Outlet is not activated");
...
function canLoadFails(route) {
  return throwError(navigationCancelingError((typeof ngDevMode === "undefined" || ngDevMode) && `Cannot load children because the guard of the route "path: '${route.path}'" returned false`, 3
...
var ApplyRedirects = class {
  ...
  findPosParam(redirectTo, redirectToUrlSegment, posParams) {
    ...
    if (!pos) throw new ɵRuntimeError(4001, (typeof ngDevMode === "undefined" || ngDevMode) && `Cannot redirect to '${redirectTo}'. Cannot find '${redirectToUrlSegment.path}'.`);
    return pos;
  }
...
var DefaultTitleStrategy = class _DefaultTitleStrategy extends TitleStrategy {
  ...
  static {
    this.ɵfac = function DefaultTitleStrategy_Factory(t) {
      return new (t || _DefaultTitleStrategy)(i0.ɵɵinject(i1.Title));
    };
  }
  static {
    this.ɵprov = /* @__PURE__ */i0.ɵɵdefineInjectable({
    ...
    switchMap(overallTransitionState => {
      ...
      tap(t => {
        ...
        if (!urlTransition && onSameUrlNavigation !== "reload") {
          ...
          this.events.next(new NavigationSkipped(t.id, this.urlSerializer.serialize(t.rawUrl), reason, 0
        ...
        if (this.urlHandlingStrategy.shouldProcessUrl(t.rawUrl)) {
          ...
          this.events.next(new NavigationSkipped(t.id, this.urlSerializer.serialize(t.extractedUrl), reason, 1
        ...
        if (t.guards.canActivateChecks.length) {
          return of(t).pipe(tap(t2 => {
            ...
            return of(t2).pipe(resolveData(this.paramsInheritanceStrategy, this.environmentInjector), tap({
              ...
              complete: () => {
                if (!dataResolved) {
                  this.cancelNavigationTransition(t2, typeof ngDevMode === "undefined" || ngDevMode ? `At least one route resolver didn't emit any value.` : "", 2
  ...
  static {
    this.ɵfac = /* @__PURE__ */(() => {
      ...
      return function DefaultRouteReuseStrategy_Factory(t) {
        return (ɵDefaultRouteReuseStrategy_BaseFactory || (ɵDefaultRouteReuseStrategy_BaseFactory = i0.ɵɵgetInheritedFactory(_DefaultRouteReuseStrategy)))(t || _DefaultRouteReuseStrategy);
      };
    })();
  }
  static {
  ...
  static {
    this.ɵfac = /* @__PURE__ */(() => {
      ...
      return function HistoryStateManager_Factory(t) {
        return (ɵHistoryStateManager_BaseFactory || (ɵHistoryStateManager_BaseFactory = i0.ɵɵgetInheritedFactory(_HistoryStateManager)))(t || _HistoryStateManager);
      };
    })();
  }
  static {
...
var Router = class _Router {
  ...
  constructor() {
    ...
    this.isNgZoneEnabled = inject(NgZone2) instanceof NgZone2 && NgZone2.isInAngularZone();
  ...
  navigateByUrl(url, extras = {
    ...
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (this.isNgZoneEnabled && !NgZone2.isInAngularZone()) {
...
var RouterLink = class _RouterLink {
  ...
  static {
    this.ɵfac = function RouterLink_Factory(t) {
      return new (t || _RouterLink)(i0.ɵɵdirectiveInject(Router), i0.ɵɵdirectiveInject(ActivatedRoute), i0.ɵɵinjectAttribute("tabindex"), i0.ɵɵdirectiveInject(i0.Renderer2), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i3.LocationStrategy));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var RouterLinkActive = class _RouterLinkActive {
  ...
  static {
    this.ɵfac = function RouterLinkActive_Factory(t) {
      return new (t || _RouterLinkActive)(i0.ɵɵdirectiveInject(Router), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.Renderer2), i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(RouterLink, 8));
    };
  }
  static {
    this.ɵdir = /* @__PURE__ */i0.ɵɵdefineDirective({
...
var RouterPreloader = class _RouterPreloader {
  ...
  static {
    this.ɵfac = function RouterPreloader_Factory(t) {
      return new (t || _RouterPreloader)(i0.ɵɵinject(Router), i0.ɵɵinject(i0.Compiler), i0.ɵɵinject(i0.EnvironmentInjector), i0.ɵɵinject(PreloadingStrategy), i0.ɵɵinject(RouterConfigLoader));
    };
  }
  static {
    this.ɵprov = /* @__PURE__ */i0.ɵɵdefineInjectable({
...
function withNavigationErrorHandler(fn) {
  const providers = [{
    ...
    multi: true,
    useValue: () => {
      const injector = inject(EnvironmentInjector2);
...
var RouterModule = class _RouterModule {
  ...
  static {
    this.ɵfac = function RouterModule_Factory(t) {
      return new (t || _RouterModule)(i0.ɵɵinject(ROUTER_FORROOT_GUARD, 8));
    };
  }
  static {
