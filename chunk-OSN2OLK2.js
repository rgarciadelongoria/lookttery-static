...
_ApiService.\u0275prov = /* @__PURE__ */ i02.\u0275\u0275defineInjectable({ token: _ApiService, factory: _ApiService.\u0275fac, providedIn: "root" });
...
_TicketService.\u0275fac = function TicketService_Factory(t) {
  return new (t || _TicketService)(i03.\u0275\u0275inject(i12.AlertController), i03.\u0275\u0275inject(i22.TranslateService), i03.\u0275\u0275inject(ApiService));
};
_TicketService.\u0275prov = /* @__PURE__ */ i03.\u0275\u0275defineInjectable({ token: _TicketService, factory: _TicketService.\u0275fac, providedIn: "root" });
...
_UserService.\u0275prov = /* @__PURE__ */ i04.\u0275\u0275defineInjectable({ token: _UserService, factory: _UserService.\u0275fac, providedIn: "root" });
var UserService = _UserService;

// src/app/services/core.service.ts
import { Injectable as Injectable5 } from "@angular/core";
import * as i05 from "@angular/core";
var _CoreService = class _CoreService {
...
_CoreService.\u0275fac = function CoreService_Factory(t) {
  return new (t || _CoreService)(i05.\u0275\u0275inject(StorageService));
};
_CoreService.\u0275prov = /* @__PURE__ */ i05.\u0275\u0275defineInjectable({ token: _CoreService, factory: _CoreService.\u0275fac, providedIn: "root" });
var CoreService = _CoreService;

// src/app/services/uuid.service.ts
var _UuidService = class _UuidService {
...
_UuidService.\u0275fac = function UuidService_Factory(t) {
  return new (t || _UuidService)(i06.\u0275\u0275inject(ApiService), i06.\u0275\u0275inject(UserService), i06.\u0275\u0275inject(CoreService));
};
_UuidService.\u0275prov = /* @__PURE__ */ i06.\u0275\u0275defineInjectable({ token: _UuidService, factory: _UuidService.\u0275fac, providedIn: "root" });
var UuidService = _UuidService;
...
_ScanComponent.\u0275fac = function ScanComponent_Factory(t) {
...
_ScanComponent.\u0275cmp = /* @__PURE__ */ i07.\u0275\u0275defineComponent({ type: _ScanComponent, selectors: [["app-scan"]], hostBindings: function ScanComponent_HostBindings(rf, ctx) {
  if (rf & 1) {
...
_MainComponent.\u0275cmp = /* @__PURE__ */ i08.\u0275\u0275defineComponent({ type: _MainComponent, selectors: [["app-main"]], viewQuery: function MainComponent_Query(rf, ctx) {
  if (rf & 1) {
...
var _CustomTranslateLoader = class _CustomTranslateLoader {
...
_CustomTranslateLoader.\u0275fac = function CustomTranslateLoader_Factory(t) {
  return new (t || _CustomTranslateLoader)(i09.\u0275\u0275inject(i15.HttpClient));
};
_CustomTranslateLoader.\u0275prov = /* @__PURE__ */ i09.\u0275\u0275defineInjectable({ token: _CustomTranslateLoader, factory: _CustomTranslateLoader.\u0275fac });
var CustomTranslateLoader = _CustomTranslateLoader;
...
var _GameService = class _GameService {
  constructor(apiSrv) {
    this.apiSrv = apiSrv;
...
_GameService.\u0275prov = /* @__PURE__ */ i010.\u0275\u0275defineInjectable({ token: _GameService, factory: _GameService.\u0275fac, providedIn: "root" });
...
var _RemoteAppComponent = class _RemoteAppComponent {
...
_RemoteAppComponent.\u0275fac = function RemoteAppComponent_Factory(t) {
...
_RemoteAppComponent.\u0275cmp = /* @__PURE__ */ i011.\u0275\u0275defineComponent({ type: _RemoteAppComponent, selectors: [["app-remote-app"]], standalone: true, features: [i011.\u0275\u0275ProvidersFeature([
  ApiService,
  UuidService,
  UserService,
  TicketService,
...
var RemoteAppComponent = _RemoteAppComponent;
(() => {
...
_HeaderComponent.\u0275cmp = /* @__PURE__ */ i012.\u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], inputs: { showMenu: "showMenu" }, standalone: true, features: [i012.\u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [["color", "primary"], ["slot", "end"], [3, "click", 4, "ngIf"], [3, "click"]], template: function HeaderComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var _CustomDatePipe = class _CustomDatePipe {
...
_CustomDatePipe.\u0275fac = function CustomDatePipe_Factory(t) {
  return new (t || _CustomDatePipe)(i013.\u0275\u0275directiveInject(i18.TranslateService, 16));
};
_CustomDatePipe.\u0275pipe = /* @__PURE__ */ i013.\u0275\u0275definePipe({ name: "date", type: _CustomDatePipe, pure: true, standalone: true });
var CustomDatePipe = _CustomDatePipe;
...
var _TicketsComponent = class _TicketsComponent {
...
_TicketsComponent.\u0275fac = function TicketsComponent_Factory(t) {
...
var TicketsComponent = _TicketsComponent;
(() => {
...
var _AppComponent = class _AppComponent {
  constructor() {
    this.title = "lookttery-app";
  }
};
_AppComponent.\u0275fac = function AppComponent_Factory(t) {
  return new (t || _AppComponent)();
};
_AppComponent.\u0275cmp = /* @__PURE__ */ i016.\u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [i016.\u0275\u0275StandaloneFeature], decls: 1, vars: 0, template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    i016.\u0275\u0275element(0, "router-outlet");
  }
}, dependencies: [CommonModule7, RouterModule6, i19.RouterOutlet], styles: ["\n\n/*# sourceMappingURL=data:application/json;base64,ewogICJ2ZXJzaW9uIjogMywKICAic291cmNlcyI6IFtdLAogICJzb3VyY2VzQ29udGVudCI6IFtdLAogICJtYXBwaW5ncyI6ICIiLAogICJuYW1lcyI6IFtdCn0K */"] });
var AppComponent = _AppComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && i016.\u0275setClassDebugInfo(AppComponent, { className: "AppComponent" });
})();

// src/bootstrap.ts
bootstrapApplication(AppComponent, appConfig).catch((err) => console.error(err));
//# sourceMappingURL=chunk-OSN2OLK2.js.map
